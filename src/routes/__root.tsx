...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Alpha Kappa Psi Beta Upsilon at the University of South Carolina — voted the #1 professional business fraternity for 18 consecutive years." },
      { name: "author", content: "AKPSI Beta Upsilon" },
      { property: "og:title", content: "Alpha Kappa Psi · Beta Upsilon at USC" },
      { property: "og:description", content: "USC's premier co-ed professional business fraternity. Developing professionalism, leadership and lifelong networks." },
